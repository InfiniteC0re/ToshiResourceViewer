...
class GameTimeFXResourceView
    : public TRBResourceView
{
public:
	GameTimeFXResourceView();
	~GameTimeFXResourceView();
...
private:
	struct LightScale_TRBHeader
	{
		TFLOAT a, b, c, d, e, f, g, h;
	};
	...
	Settings_TRBHeader*   m_pSettings;
	LightScale_TRBHeader* m_pLightScale;
	TINT                  m_iNumFXs;
};
